...
export const CATALOGOS: CatalogoDef[] = [
  ...
  {
    slug: 'destinos-bitacora',
    titulo: 'Destinos de bitácora',
    tituloSingular: 'destino',
    descripcion: 'Lugares frecuentes (talleres, bancos, proveedores…) que aparecen como atajo en el Destino de la Bitácora de uso.',
    tabla: bitacoraDestinos,
    columnas: { codigo: bitacoraDestinos.codigo, nombre: bitacoraDestinos.nombre, descripcion: bitacoraDestinos.descripcion, activo: bitacoraDestinos.activo },
    campos: CAMPOS_BASE,
    jerarquico: false,
  },
  {
