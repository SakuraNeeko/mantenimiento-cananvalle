...
export const ROLE_MATRIX: Record<RoleCode, readonly PermissionCode[]> = {
  ...
  GERENTE: [
    ...
    'activos.documentos.gestionar', 'activos.qr.generar', 'activos.hoja_vida.ver', 'activos.importar',
    'almacen.materiales.ver', 'almacen.materiales.gestionar', 'almacen.existencias.ver',
  ...
  PLANIF: [
    ...
    'activos.qr.generar', 'activos.hoja_vida.ver', 'activos.importar',
    'almacen.materiales.ver', 'almacen.existencias.ver', 'almacen.kardex.ver',
  ...
  SUPERV: [
    ...
    'activos.hoja_vida.ver',
    'almacen.materiales.ver', 'almacen.existencias.ver', 'almacen.kardex.ver', 'almacen.kardex.salida',
    'solicitudes.ver', 'solicitudes.crear', 'solicitudes.editar', 'solicitudes.aprobar',
    'solicitudes.rechazar', 'solicitudes.asignar', 'solicitudes.atender',
    'solicitudes.atencion_directa', 'solicitudes.convertir_ot', 'solicitudes.cerrar',
    'ordenes.ver', 'ordenes.crear', 'ordenes.editar', 'ordenes.planificar', 'ordenes.asignar',
  ...
  AUDITOR: [
    ...
    'activos.ver', 'activos.costos.ver', 'activos.hoja_vida.ver',
    'almacen.materiales.ver', 'almacen.existencias.ver', 'almacen.kardex.ver', 'almacen.costos.ver',
    'solicitudes.ver',
